...
execute as @a at @s if score relay_dummy relay_B = @s relay_number run summon minecraft:armor_stand ~ ~ ~ {Invisible:0b,Invulnerable:1b,Marker:1b,NoGravity:1b,Tags:["cage_temp"]}
...
schedule function original:item/cage_destroy 1s append